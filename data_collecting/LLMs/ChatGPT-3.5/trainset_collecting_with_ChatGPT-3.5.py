...
filename = 'data/LLMs/ChatGPT-3.5/triplet_dataset/trainset_ChatGPT_3.5.txt'
...
for trial in range(start_trial,end_trial):
    ...
    write_trial_data_to_csv('data/LLMs/ChatGPT-3.5/triplet_dataset/prompts&responses_trainset_ChatGPT_3.5.csv', group_results, group_prompts, group_responses)

    print("model:", sorted_images)
    # Save the sorted image numbers to a txt file
    with open('data/LLMs/ChatGPT-3.5/triplet_dataset/trainset_ChatGPT_3.5.txt', 'a') as f:
