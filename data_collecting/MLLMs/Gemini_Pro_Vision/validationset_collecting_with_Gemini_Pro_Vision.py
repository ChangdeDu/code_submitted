...
filename = 'data/MLLMs/Gemini_Pro_Vision/triplet_dataset/validationset_Gemini_Pro_Vision.txt'
if not os.path.exists(filename):
    with open(filename, 'w') as file:
        pass
line_count = count_lines(filename)

validationset_humans = 'data/Humans/triplet_dataset/validationset.txt'
total_lines = count_lines(validationset_humans)
...
with open(validationset_humans,
          'r') as f:
...
for trial in range(start_trial, end_trial):
    ...
    write_trial_data_to_csv('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/prompts&responses_validationset_Gemini_Pro_Vision.csv', group_results,
                            group_prompts, group_responses)

    print("model:", sorted_images)
    # Save the sorted image numbers to a txt file
    with open('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/validationset_Gemini_Pro_Vision.txt', 'a') as f:
