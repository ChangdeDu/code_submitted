...
filename = 'data/MLLMs/Gemini_Pro_Vision/triplet_dataset/full_sampling_for_48_objects_Gemini_Pro_Vision.txt'
if not os.path.exists(filename):
    with open(filename, 'w') as file:
        pass
line_count = count_lines(filename)

full_sampling = 'data/LLMs/ChatGPT-3.5/triplet_dataset/full_sampling_for_48_objects_ChatGPT-3.5.txt'
...
for trial in range(start_trial, end_trial):
    ...
    write_trial_data_to_csv('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/prompts&responses_full_sampling_for_48_objects_Gemini_Pro_Vision.csv', group_results,
                            group_prompts, group_responses)

    print("model:", sorted_images)
    # Save the sorted image numbers to a txt file
    with open('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/full_sampling_for_48_objects_Gemini_Pro_Vision.txt', 'a') as f:
