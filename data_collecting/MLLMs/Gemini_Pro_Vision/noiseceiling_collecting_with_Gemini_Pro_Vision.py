...
filename = 'data/MLLMs/Gemini_Pro_Vision/triplet_dataset/noiseceiling_Gemini_Pro_Vision.txt'
...
for trial in range(start_trial, end_trial):
    ...
    write_noisecelling_data_to_csv('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/prompts&responses_noiseceiling_Gemini_Pro_Vision.csv', split_line1, split_line2,
                                   split_line3, choose_ind, group_prompts, group_responses)

    print("model:", sorted_images)
    # Save the sorted image numbers to a txt file
    with open('data/MLLMs/Gemini_Pro_Vision/triplet_dataset/noiseceiling_Gemini_Pro_Vision.txt', 'a') as f:
